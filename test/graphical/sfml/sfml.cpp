...
//    Triple<object_creation_data, object_type,
//        void *> *real = static_cast<Triple<object_creation_data, object_type,
//    void *> *> (object);
...
//    (object);
//    Triple<object_creation_data, object_type, void
//    *> * real = static_cast<Triple<object_creation_data, object_type, void
//    *> *>(object);
//    for (auto &tmp : _objects)
//    {
//        if (tmp->third == object)
...
//std::vector<object_creation_data> sfml::getObjectData() {
//    return _objects;
//}
