...
//std::vector<object_creation_data> GraphicalLib::getObjectData()
//{
//    std::vector<object_creation_data> (*getObjectData)();
//
//    getObjectData = reinterpret_cast<typeof getObjectData>
//        (loadFunc("getObjectData"));
